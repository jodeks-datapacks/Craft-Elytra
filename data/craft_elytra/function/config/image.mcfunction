function craft_elytra:image/set_image_data {\
  width: 8,\
  height: 8,\
  image_data: [\
  ...
  description: [\
    {text: "Craft Elytras"},\
    {translate: "craft_elytra.description", fallback: "Makes Elytras craftable"},\
    "",\
    ...
    {text: "modrinth.com/datapack/craft-elytras", color: "#a800a8"},\
    "",\
    "",\
    "",\
    "",\
